...
router.get("/admission", authenticateUser, authorize("admin", "admission"), getAdmissionStats);

// Student dashboard stats - student can only access their own stats
router.get("/student/:studentId", authenticateUser, authorize("admin", "admission", "student"), getStudentStats);
