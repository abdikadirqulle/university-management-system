...
export const getAdminStats = async (req, res) => {
  try {
    ...
    const [studentsCount, facultiesCount, departmentsCount, coursesCount] = await Promise.all([
...
export const getFinancialStats = async (req, res) => {
  try {
    ...
    const [totalPayments, pendingPayments, paidPayments, overduePayments] = await Promise.all([
